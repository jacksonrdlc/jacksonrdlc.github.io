...
Welcome to my [personal website](https://jacksonrdlc.com)! This is an [MIT licensed](https://github.com/jacksonrdlc/personal-site/blob/main/LICENSE) React-based Jamstack application. It offers a simple interface, easy modifications, static export capabilities, and free automatic deployments via [GitHub Pages](https://pages.github.com/).
...
1. Clone the repository:
    ...
    ```bash
    git clone git://github.com/jacksonrdlc/personal-site.git
    cd personal-site
    ```
...
- Kudos to [@notrueblood](https://github.com/notrueblood)[<sup>[1]</sup>](https://github.com/jacksonrdlc/personal-site/pull/218) and [@sjhsieh](https://github.com/sjhsieh)[<sup>[2]</sup>](https://github.com/jacksonrdlc/personal-site/issues/168) for their constructive feedback.
